...
namespace SportsClub.Data.Migrations
{
    ...
    [Migration("20260319091559_ActivityValidation")]
    partial class ActivityValidation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivityMember", b =>
                {
                    ...
                    b.HasKey("ActivitiesActivityId", "MembersMemberId");
            ...
            modelBuilder.Entity("SportsClub.Models.Activity", b =>
                {
            ...
            modelBuilder.Entity("SportsClub.Models.Snack", b =>
                {
                    ...
                    b.Property<string>("SnackDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasData(
                        ...
                        {
                            SnackId = 1,
                            SnackDescription = "Salted potato chips (bag)",
                            SnackName = "Chips",
                            SnackPrice = 1.50m
                        },
                        new
                        {
                            SnackId = 2,
                            SnackDescription = "Milk chocolate 50g",
            ...
            modelBuilder.Entity("ActivityMember", b =>
                {
                    b.HasOne("SportsClub.Models.Activity", null)
                        .WithMany()
                        .HasForeignKey("ActivitiesActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportsClub.Models.Member", null)
                        .WithMany()
